-- CREATE SEQUENCE 
DROP USER IF EXISTS imagedockadmin;
CREATE USER imagedockadmin WITH SUPERUSER CREATEDB CREATEROLE LOGIN PASSWORD 'imagedockpass';

GRANT ALL PRIVILEGES ON DATABASE imagedock TO imagedockadmin;
